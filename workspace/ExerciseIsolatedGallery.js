...
document.getElementById("previewimage").src = "images/IsolatedExercises/Curls.jpg";
...
document.getElementById("previewimage").src = "images/IsolatedExercises/Barbell Front Raises.jpg";
...
document.getElementById("previewimage").src = "images/IsolatedExercises/Cable Crossover Flys.jpg";
document.getElementById("imagecell1").style.backgroundColor = "#003F64";
document.getElementById("imagecell2").style.backgroundColor = "#003F64";
...
document.getElementById("previewimage").src = "images/IsolatedExercises/Leg Curls.jpg";
document.getElementById("imagecell1").style.backgroundColor = "#003F64";
document.getElementById("imagecell2").style.backgroundColor = "#003F64";
document.getElementById("imagecell3").style.backgroundColor = "#003F64";
...
document.getElementById("previewimage").src = "images/IsolatedExercises/Leg Extensions.jpg";
document.getElementById("imagecell1").style.backgroundColor = "#003F64";
document.getElementById("imagecell2").style.backgroundColor = "#003F64";
document.getElementById("imagecell3").style.backgroundColor = "#003F64";
document.getElementById("imagecell4").style.backgroundColor = "#003F64";
...
document.getElementById("previewimage").src = "images/IsolatedExercises/Sit Ups.jpg";
document.getElementById("imagecell1").style.backgroundColor = "#003F64";
document.getElementById("imagecell2").style.backgroundColor = "#003F64";
document.getElementById("imagecell3").style.backgroundColor = "#003F64";
document.getElementById("imagecell4").style.backgroundColor = "#003F64";
...
document.getElementById("previewimage").src = "images/IsolatedExercises/Tricep Extension.jpg";
document.getElementById("imagecell1").style.backgroundColor = "#003F64";
document.getElementById("imagecell2").style.backgroundColor = "#003F64";
document.getElementById("imagecell3").style.backgroundColor = "#003F64";
document.getElementById("imagecell4").style.backgroundColor = "#003F64";
...
document.getElementById("previewimage").src = "images/IsolatedExercises/Floor Hip Extensions.jpg";
document.getElementById("imagecell1").style.backgroundColor = "#003F64";
document.getElementById("imagecell2").style.backgroundColor = "#003F64";
document.getElementById("imagecell3").style.backgroundColor = "#003F64";
document.getElementById("imagecell4").style.backgroundColor = "#003F64";
